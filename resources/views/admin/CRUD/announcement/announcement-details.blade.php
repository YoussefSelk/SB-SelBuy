            ...
            <form id="announcementForm" action="{{ route('announcement.update', $announcement->id) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <select name="city" id="announcementCity"
                        ...
                        <option value="Al Hoceima" @if ($announcement->city == 'Al Hoceima') selected @endif>Al Hoceima
                        </option>
                        ...
                        <option value="Benslimane" @if ($announcement->ville == 'Benslimane') selected @endif>Benslimane
                        </option>
                        ...
                        <option value="El Jadida" @if ($announcement->ville == 'El Jadida') selected @endif>El Jadida
                        </option>
                        <option value="Erfoud" @if ($announcement->ville == 'Erfoud') selected @endif>Erfoud</option>
                        <option value="Essaouira" @if ($announcement->ville == 'Essaouira') selected @endif>Essaouira
                        </option>
                        ...
                        <option value="Khemisset" @if ($announcement->ville == 'Khemisset') selected @endif>Khemisset
                        </option>
                        <option value="Khenifra" @if ($announcement->ville == 'Khenifra') selected @endif>Khenifra
                        </option>
                        <option value="Khouribga" @if ($announcement->ville == 'Khouribga') selected @endif>Khouribga
                        </option>
                        <option value="Ksar El Kebir" @if ($announcement->ville == 'Ksar El Kebir') selected @endif>Ksar El
                            Kebir
                        </option>
                        <option value="Laayoune" @if ($announcement->ville == 'Laayoune') selected @endif>Laayoune
                        </option>
                        <option value="Larache" @if ($announcement->ville == 'Larache') selected @endif>Larache
                        </option>
                        ...
                        <option value="Oualidia" @if ($announcement->ville == 'Oualidia') selected @endif>Oualidia
                        </option>
                        ...
                        <option value="Tangier" @if ($announcement->ville == 'Tangier') selected @endif>Tangier
                        </option>
                        ...
                        <option value="Tetouan" @if ($announcement->ville == 'Tetouan') selected @endif>Tetouan
                        </option>
